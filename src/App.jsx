        ...
        <div className="footer-top">
          ...
          <div className="footer-brand">
            ...
            <div className="footer-bcorp">
              <svg width="32" height="40" viewBox="0 0 60 75" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Certified B Corporation">
                <rect width="60" height="75" rx="4" fill="rgba(255,255,255,0.12)"/>
                <text x="30" y="28" textAnchor="middle" fill="white" fontSize="11" fontWeight="700" fontFamily="sans-serif">CERTIFIED</text>
                <text x="30" y="46" textAnchor="middle" fill="white" fontSize="22" fontWeight="900" fontFamily="sans-serif">B</text>
                <text x="30" y="62" textAnchor="middle" fill="white" fontSize="11" fontWeight="700" fontFamily="sans-serif">CORPORATION</text>
              </svg>
